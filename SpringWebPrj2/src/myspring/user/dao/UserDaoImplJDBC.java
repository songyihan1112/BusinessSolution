...
public class UserDaoImplJDBC implements UserDao {
	...
	public void insert(UserVO user) {
		...
		System.out.println("아이디 등록 Record UserId=" + user.getUserId() + " Name=" + user.getName());
	}
	...
	public void delete(String id) {
		...
		System.out.println("삭제 완료 Record with ID = " + id ); 
	}
	...
	public void update(UserVO user) {
		...
		System.out.println("업데이트 Record with ID = " + user.getUserId() ); 
	}
